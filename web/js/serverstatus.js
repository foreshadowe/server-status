                       ...
                       ' <div class="panel panel-block panel-block-sm panel-location">'+
                         ...
                         '   </div>'+
                          ...
                          '  </div>'+
                           ...
                           '     <li><span class="list-label">Load:</span> @load%</li>'+
                         '   </ul>'+
                      '  </div>'+
                   ' </div>';
        ...
        for (var i = 0; i < result.servers.length; i++) {
          ...
          //----jieshu
            ...
            if (result.servers[i].online4) {
                ...
                TableRow.children["online4"].children[0].children[0].innerHTML = "<small>Online</small>";
            } else {
                TableRow.children["online4"].children[0].children[0].className = "progress-bar progress-bar-danger";
                TableRow.children["online4"].children[0].children[0].innerHTML = "<small>Offline</small>";
            }

            // Online6
            //if (result.servers[i].online6) {
            //	TableRow.children["online6"].children[0].children[0].className = "progress-bar progress-bar-success";
            //	TableRow.children["online6"].children[0].children[0].innerHTML = "<small>Open</small>";
            //} else {
